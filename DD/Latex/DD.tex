...
%----------------------------------------------------------------------------
    ...
    \puttitle{
        ...
        name1=Federico Zanca, % Author Name and Surname
        name2=Federico Costantini,
        name3=Michele Zhenghao Zhuge,
...
%-------------------------------------------------------------------------
    ...
    \input{Chapters/2_-_Architectural_Design}


    \chapter{User Interface Design}
    \label{ch:user_interface_design}%
    \input{Chapters/3_-_User_Interface_Design}


    \chapter{Requirements Traceability}
    \label{ch:requirements_traceability}%
    \input{Chapters/4_-_Requirements_Traceability}


    \chapter{Implementation, Integration and Test Plan}
    \label{ch:implementation_integration_test_plan}%
    \input{Chapters/5_-_Implementation_Integration_Test_Plan}


    \chapter{Effort Spent}
    \label{ch:effort_spent}%
    \input{Chapters/6_-_Effort_Spent}

    \chapter{References}
    \label{ch:references}%
    \input{Chapters/7_-_References}
