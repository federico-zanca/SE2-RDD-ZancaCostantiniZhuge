...
\begin{itemize}
    ...
    \item GitHub needs to provide APIs to allow the CKB platform to be notified when Actions are performed and let group repo to be pulled for the evaluation.
\end{itemize}