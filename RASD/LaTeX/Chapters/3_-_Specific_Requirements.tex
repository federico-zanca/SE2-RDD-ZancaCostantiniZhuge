...
\begin{center}
    \begin{longtable}{|p{0.06\linewidth}|p{0.34\linewidth}|p{0.6\linewidth}|}
        ...
        \hline
        G\cmg         & D9                           & R23, R24, R25, R29, R30                        \\
        \hline
        G\cmg         & D2, D11                            & R24, R25, R26, R27, R28                                      \\
        \hline
        G\cmg         & D1, D5, D6                            & R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20                                \\
        \hline
        G\cmg         & D7                            & R33, R34, R35, R36, R37, R38, R39              \\
        \hline
        G\cmg         & D5, D6                            & R20, R29, R30, R44                               \\
        \hline
        G\cmg         & D3, D7                            & R41, R42, R45                     \\
        \hline
        G\cmg         & D2                            & R46, R47                                \\
        \hline
        G\cmg         & D8                            & R48                                                   \\
        \hline
        G\cmg         & D8                            & R16, R17, R18, R19, R48                                               \\
        \hline
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{[D.9]} Students have basic knowledge of at least one programming language supported by the \verb|CKB| platform.
    \end{itemize}
    ...
    \item \textbf{{[G.2]} Facilitate peer learning and collaboration by allowing students to form teams and work together on coding exercises. }
        \begin{itemize}
            ...
            \item \textbf{[D.2]}  All users of the \verb|CKB| platform, both educators and students, are assumed to have access to a stable internet connection. This is
            necessary fir accessing the platform, downloading code kata, submitting code, and receiving notification.     
            \item \textbf{[D.11]} Github repo collaborators are coherent with respect to groups created in the \verb|CKB| platform for a given battle.
        ...
        \begin{itemize}
            ...
            \item \textbf{[D.7]} The scroing system is transparent, consistent, and coherent with the criteria of the rules (quality of sources, timeliness, ...)
...
\begin{center}
    \begin{longtable}{lp{0.75\linewidth}}
        ...
        & 6. The educator writes an arithmetic expression combining the selected metrics in the input box on the right of the list\\
        ...
        & 13. The educator writes a mathematical expression combining the selected variables in the input box on the right of the list\\
        & 14. The educator clicks on the "Create" button\\
    ...
    %    \begin{figure} [H]
    %        \begin{center}
                %\includegraphics[width=0.9\linewidth]{Images/SequenceDiagrams/manual_evaluation}
...
\begin{center}
    ...
    %    \begin{figure} [H]
    %        \begin{center}
                %\includegraphics[width=0.9\linewidth]{Images/SequenceDiagrams/show_leaderboard}
   %             \caption{Visualization of tournament leaderboard Sequence Diagram}
%                \label{fig: torunament_leaderboard_use_case}
    %        \end{center}
   %     \end{figure}
    %    \end{comment}
\end{center}
...
\begin{center}
    ...
    %    \begin{figure} [H]
    %        \begin{center}
    %            \includegraphics[width=0.9\linewidth]{Images/SequenceDiagrams/view_profile}
    %            \caption{Visualization of tournament leaderboard Sequence Diagram}
    %            \label{fig: view_profile_use_case}
    %        \end{center}
   %     \end{figure}
    %    \end{comment}
\end{center}
...
\begin{center}
    ...
    %    \begin{figure} [H]
    %        \begin{center}
    %            \includegraphics[width=0.9\linewidth]{Images/SequenceDiagrams/ckb_ranking}
    %            \caption{Visualization of CKB leaderboard Sequence Diagram}
    %            \label{fig: ckb_ranking_use_case}
    %        \end{center}
   %     \end{figure}
    %    \end{comment}
\end{center}
