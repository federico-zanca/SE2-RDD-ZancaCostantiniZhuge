...
\subsubsection*{UC\cuc . Student accept an invitation}
\begin{center}
    \begin{longtable}{lp{0.75\linewidth}}
        \hline
        Actor            & Student                                                                                                                                                                               \\
        \hline
        Entry conditions & The student is logged in on the \verb|CKB| platform and receives and invitation.                                                                                                               \\
        \hline
        Event Flow       
        & 1. The student receives a pop-up norification of the invitation.\\
        & 2. The student clicks on the accept button of the invitation pop-up.\\
        ...
        \hline
        Exit condition   & Invitation accepted.   \\                                                                                                                                                                           
        \hline
        Exceptions   
...
\begin{center}
    \begin{longtable}{lp{0.75\linewidth}}
        ...
        & 4. The \verb|CKB| platform communicates the outcome of the invitation to both students.\\
        \hline
        Exit condition   & Invitation rejected.   \\                                                                                                                                                                           
        \hline
...
\begin{center}
    \begin{longtable}{lp{0.75\linewidth}}
        ...
        Actor            & Student                                                                                                                                                                               \\
        \hline
        Entry conditions & The Student is logged in on the \verb|CKB| platform and participating in a tournament.                                                                                                            \\
        \hline
        Event Flow       
        & 1. The student selects a battle on the list of battles in the tournament page.\\
        ...
        \hline
        Exit condition   & Student joined the battle.   \\                                                                                                                                                                           
        \hline
        Exceptions   
