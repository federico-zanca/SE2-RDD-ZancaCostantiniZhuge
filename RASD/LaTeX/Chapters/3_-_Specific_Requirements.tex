...
%CKB platform from the "sign-in" page. Then, from the menu option in the home page,
%he selects "Create a new tournament". He is prompted with the page of the setup for
%the tournament itself. Achille enters a name for the tournament and the registration
%deadline. He then toggles the "advanced options" section. From here, he can decide
%wheter to include or not badges, and, in the first case, which badges are available in
%the tournament. Achille is prompted with a set of pre-existing badges (created from the
%platform or in previous tournaments). He can decide to create new badges in addition
%to the ones already present. When choosing to create a new badge, a pop-up window
%appears where he can select and combine variables and rules to obtain the new badge.
%Once he finishes setting up everything, he pushes the "Create tournament" button at the
%bottom of the page.
